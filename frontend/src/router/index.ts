  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'vehicles/:id', name: 'vehicle-detail', component: () => import('@/views/VehicleDetailView.vue') },
        ...
        { path: 'admin/vehicle-cost-types', name: 'admin-vehicle-cost-types', component: () => import('@/views/admin/VehicleCostTypesView.vue'), meta: { admin: true } },
      ],
    },
  ],
})
